...
export const randomProductListReducer = ( state = { products: [] }, action) => {
    switch(action.type) {
        case RANDOM_PRODUCT_LIST_REQUEST:
            return { loading: true, products: [] };
        case RANDOM_PRODUCT_LIST_SUCCESS:
            return { loading: false, products: action.payload }
        case RANDOM_PRODUCT_LIST_FAIL:
            return { loading: false, error: action.payload };
        default:
            return state;
    }
